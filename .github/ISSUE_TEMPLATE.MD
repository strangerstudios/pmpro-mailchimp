...
<!-- Usage questions can also be directed to our support page here: https://www.paidmembershipspro.com/support/ -->
...
- [ ] The issue still exists against the latest `dev` branch of Paid Memberships Pro on Github (this is **not** the same as the current stable version!)
...
- [ ] This bug happens with only Paid Memberships Pro plugin and Paid Memberships Pro - Mailchimp Add On active
